...
extension PhotoCropView : CropViewDelegate {
    
    public func cropViewDidStartCrop(_ cropView: CropView) {
        self.highlightMask(true, animate: true)
        self.manualMove = true
    }
    
    public func cropViewDidMove(_ cropView: CropView) {
        self.updateMasks()
    }
    
    public func cropViewDidStopCrop(_ cropView: CropView) {
    ...
    public func cropViewInsideValidFrame(for point: CGPoint, from cropView: CropView) -> Bool {

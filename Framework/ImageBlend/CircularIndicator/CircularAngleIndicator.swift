//
//  CircularAngleIndicator.swift
//  CircularAngleIndicator
//
...
@objc public enum CircularAngleIndicatorGlowMode: Int {
    case forward, reverse, constant, noGlow
}

@IBDesignable
public class CircularAngleIndicator: UIView, CAAnimationDelegate {
    ...
    @IBInspectable public var glowMode: CircularAngleIndicatorGlowMode = .forward {
        didSet {
    ...
    public func change(toAngle: Double) {
        angle = toAngle
    }
    ...
    private class KDCircularProgressViewLayer: CALayer {
        ...
        var glowMode: CircularAngleIndicatorGlowMode = .forward
        ...
        private enum GlowConstants {
            ...
            static func glowAmount(forAngle angle: Double, glowAmount: CGFloat, glowMode: CircularAngleIndicatorGlowMode, size: CGFloat) -> CGFloat {
                switch glowMode {
                case .forward:
